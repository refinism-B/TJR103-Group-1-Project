...
CREATE TABLE Hospital(
	hospital_id VARCHAR(20) NOT NULL COMMENT '醫院id',
	place_id VARCHAR(50) NOT NULL COMMENT 'gmap的id',
	name VARCHAR(150) NOT NULL COMMENT '醫院名稱',
	address VARCHAR(150) NOT NULL COMMENT '醫院地址',
	phone VARCHAR(20) COMMENT '醫院電話',
	city VARCHAR (15) NOT NULL COMMENT '醫院所在市',
	district VARCHAR(30) NOT NULL COMMENT '醫院所在區',
	...
	website VARCHAR(500) COMMENT '醫院官網',
...
CREATE TABLE Hotel(
	...
	updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改時間',
	-- CONSTRAINT
	PRIMARY KEY(hotel_id) -- 	FOREIGN KEY(loc_id) REFERENCES location(loc_id)
	-- 	FOREIGN KEY(cat_id) REFERENCES category(category_id)
) COMMENT = '寵物旅館資料表';